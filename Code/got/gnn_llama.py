...
class GnnLlamaConfig(LlamaConfig):
    model_type = "GnnLlama"

class GnnLlamaModel(LlamaModel):
    """
...
AutoConfig.register("GnnLlama", GnnLlamaConfig)
AutoModelForCausalLM.register(GnnLlamaConfig, GnnLlamaForCausalLM)