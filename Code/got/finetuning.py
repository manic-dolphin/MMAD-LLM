...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default='/data/yanyuliang/Code/got/hf_models/llama2/llama2-7b-chat')
    # model_name_or_path: str = './hf_models/llama2/llama2-7b-chat'
    
@dataclass
class DataArguments:
    data_path: str = field(default='./data/chem_data/orderly_train', metadata={"help": "Path to the training data."})

@dataclass
class TrainingArguments(transformers.TrainingArguments):
    output_dir: Optional[str] = field(default='./ft_output')
...
if __name__ == '__main__':
    ...
    # # print(model)
    # strings = ["hello", "fuck you"]
    # tokenized_list = [tokenizer(text, return_tensors='pt') for text in strings]
    # print([tokenized.input_ids[0] for tokenized in tokenized_list])
    train()