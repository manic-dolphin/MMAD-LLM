...
if __name__ == '__main__':
    ...
    print("------------------")
    print(operations.score(initial_thought)[0])
    print(operations.score(initial_thought)[1])
    # got.reason(5, 3)
